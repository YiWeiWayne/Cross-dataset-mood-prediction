...
feature = 'rCTA'  # 1.melSpec 2.rCTA 3.melSpec_lw
...
for emotion_axis in ['valence']:
    ...
    extractor = model_structure.compact_cnn_extractor(feature_tensor=feature_tensor, poolings=poolings)
