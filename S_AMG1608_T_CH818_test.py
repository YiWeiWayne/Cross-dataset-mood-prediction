...
transfer_execute_name = save_path + '/' + \
                        algorithm + '_S_' + source_dataset_name + '_T_' + target_dataset_name + '_20180416.1625.56'
...
save_data(source_execute_name + '/' + target_dataset_name + '_regressor_fullset.xls', data)
...
data.update({"R2_pearsonr_max": [[emotions[0]], [CH818_R2_pearsonr_max[emotions[0]]],
                                 [emotions[1]], [CH818_R2_pearsonr_max[emotions[1]]]]})
save_data(transfer_execute_name + '/' + target_dataset_name + '_transfer_regressor_fullset.xls', data)
